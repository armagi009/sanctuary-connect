...
export default {
  ...
  theme: {
  	extend: {
  		...
  		colors: {
        'sanctuary-background': '#FAF8F5',
        'sanctuary-text': '#6B7A8F',
        'sanctuary-accent': '#C4A484',
  		...
  		boxShadow: {
  			...
  			glow: '0 0 20px -5px rgba(196, 164, 132, 0.4)',
  			'glow-lg': '0 0 40px -10px rgba(196, 164, 132, 0.3)',
  		...
  		keyframes: {
  			...
  			glow: {
  				'0%, 100%': {
  					boxShadow: '0 0 20px -5px rgba(196, 164, 132, 0.4)'
  				},
  				'50%': {
  					boxShadow: '0 0 40px -5px rgba(196, 164, 132, 0.6)'
  				}
  			},
  			float: {
  				'0%, 100%': {
  		...
  		backgroundImage: {
  			...
  			'gradient-primary': 'linear-gradient(135deg, #C4A484, #b08f6e)',
